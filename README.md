...
```text
Họ và tên: Ngô Dương Gia Bảo
Mã số sinh viên: 110124008
Lớp: DA24TTB
Tên đề tài: Thiết kế trang web bán cây cảnh mini GB Garden sử dụng HTML, CSS, JavaScript, BootStrap
Liên kết GitHub repository: https://github.com/TKW-22526/final-test-web-design-giabaeoz.git
Liên kết GitHub Pages: https://tkw-22526.github.io/final-test-web-design-giabaeoz/
```
